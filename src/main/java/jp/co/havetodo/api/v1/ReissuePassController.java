...
import jp.co.havetodo.api.payload.request.ReissuePassRequest;
...
public class ReissuePassController {
    ...
    public Mono<ResponseEntity<LoginResponse>> authReissuePass(@RequestParam("authToken") final String authToken) {
